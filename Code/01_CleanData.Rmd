...
dim(rawdata)[1] #Extract total number of rows, which roughly corresponds to number of participants. However, some of these are my own survey previews, and one row is a "junk" row that only contains variable labels.
```
...
#Append relationship length variables to the end of the 'full' dataframe
